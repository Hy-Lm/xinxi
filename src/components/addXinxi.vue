			...
			<div class="operationBoxItem">
				...
				<div class="BoxItem">
					...
					<div class="BoxItemList">
						...
						<el-input v-model="row.fatherName" placeholder="请输入父亲姓名" name="fatherName"
					...
					<div class="BoxItemList">
						...
						<el-input v-model="row.motherName" placeholder="请输入母亲姓名" name="motherName"
							style="width: 240px;"></el-input>
					</div>
					<div class="BoxItemList">
						<label style="">联系电话 :</label>
					...
					<div class="BoxItemList">
						...
						<el-input v-model="row.majorTeacher" placeholder="请输入专业老师" name="majorTeacher"
							style="width: 240px;"></el-input>
						<!-- <div v-if="!boxShow" class="BoxItemListDiv">{{row.particulars}}</div> -->
					</div>
					<div class="BoxItemList">
					...
					<div class="BoxItemList">
						...
						<el-input type="textarea" placeholder="请输入备注信息" class="address" name="remark"
